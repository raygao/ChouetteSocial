...
ChouetteSocial::Application.config.session_store :active_record_store
#ChouetteSocial::Application.config.session_store :cookie_store

ChouetteSocial::Application.config.session = {
  :key          => '_chouette_social_session',     # name of cookie that stores the data
